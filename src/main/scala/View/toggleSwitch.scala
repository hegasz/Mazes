...
/** Class for making toggle switches
  * @param onColour colour of slider when switch is on (to the right)
  * @param offColour colour of slider when switch is on (to the left)
  * @param thumbColour colour of switch thumb
  */
